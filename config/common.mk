...
$(call inherit-product, vendor/blaze/config/apps.mk)
$(call inherit-product, vendor/blaze/config/bootanimation.mk)
$(call inherit-product, vendor/blaze/config/common_telephony.mk)
